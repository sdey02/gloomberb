 ...
 * hands the request to `DeviceSignInDialogHost`, which is always mounted via the
 * cloud plugin's status widget slot and owns the actual dialog.
 */
...
import { renderQrLines } from "../../../ui/qr";
